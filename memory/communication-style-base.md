...
1a. **Если код нужен — только после русского названия, в скобках.** Не «WP-330 cutover», а «переход на новую версию марафона (РП330)». Не «G3 PASS», а «финальная проверка перед запуском (G3) прошла успешно». Не «PD.METHOD.008», а «каскад ВДВ (PD.METHOD.008)».
